...

{
 ...
 /**
  ...
  public boolean connect(String name, String address)
  {
    ...
    System.out.println(" connect result " + con.getNXTInfo().name + ", " + con.getNXTInfo().deviceAddress);
...
/**
 ...
 /**
   ...
   */
  public void exit(){
	  send(RemotePilotMethod.EXIT, 0, 0, false);
  }
   ...
   * Shoot cue
   */
  public void shoot(float dist){
	  send(RemotePilotMethod.SHOOT, dist, 0, false);
  }
  ...
  public void setShootSpeed(float speed){
	  send(RemotePilotMethod.SETSHOTSPEED, speed, 0, false);
  }
